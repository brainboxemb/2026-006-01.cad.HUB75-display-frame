...
// The plate arm width follows the physical rail plus the configured fitted wall.
// Guide end shaping is handled as an intersection with this authoritative plate
// profile; it must never enlarge the plate to compensate for a guide crop.
