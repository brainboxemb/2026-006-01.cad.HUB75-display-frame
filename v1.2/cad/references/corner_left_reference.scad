// HUB75 V1.2 - TOP LEFT corner reference
// Coupler local (0,0) is the nominal top-left panel corner. The panel itself
...
color("black") {
    ...
    ref_hline(-10,170,0,0.85);
    ref_cross([0,0],8,0.85);
    ref_label("CORNER LEFT / TOP (0,0)", [4,8], 4.0, "left", "bottom");
