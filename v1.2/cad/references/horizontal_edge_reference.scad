// HUB75 V1.2 - HORIZONTAL EDGE reference
// Two portrait panels side by side. Coupler local (0,0) is where their nominal
// vertical seam meets the nominal TOP display edge.
...
pitch_z = ref_panel_nominal_height();
left_center  = [-pitch_x/2, -pitch_z/2];
right_center = [ pitch_x/2, -pitch_z/2];
view_w = 370;
view_h = 370;
...
color("black") {
    ...
    ref_hline(-175,175,0,0.85);
    ref_cross([0,0],8,0.85);
    ref_label("HORIZONTAL EDGE (0,0)", [4,8], 4.0, "left", "bottom");
    ref_label("panel L (-80,-160)", [-80,-328], 3.0, "center", "top");
    ref_label("panel R (+80,-160)", [80,-328], 3.0, "center", "top");
}
if(show_legend) hub75_reference_legend_2d([-175,15]);
